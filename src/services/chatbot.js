...
const CLAVES = {
  1: {
    ...
    answer: [
      ...
      '',
      'Para restablecer tu clave de correo, contacta a:',
      '',
      '👤 *Kevin Arriagada*',
      '📱 +569 30919502',
      '',
  ...
  2: {
    ...
    answer: [
      ...
      '',
      'Para restablecer tu token/password de WSL, contacta a:',
      '',
      '👤 *Kevin Arriagada*',
      '📱 +569 30919502',
      '',
  ...
  3: {
    ...
    answer: [
      ...
      '',
      'Para restablecer tu clave de Intranet, contacta a:',
      '',
      '👤 *Rony Castillo*',
      '📱 +569 76590469',
      '',
  ...
  4: {
    ...
    answer: [
      ...
      '',
      'Para restablecer tu clave de DBNet, contacta a:',
      '',
      '👤 *Julio Castillo*',
      '📱 +569 57190055',
      '',
