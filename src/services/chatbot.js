...
const TEXTS = {
  welcome: [
    'Hola *¡Bienvenido a Soporte Informatica Wurth!* 🖥️🔧',
    '',
    'Contanos en que podemos ayudarte 👇',
    '',
    '━━━━━━━━━━━━━━━━━━━━',
    '*1.* 🔑 Problemas con su clave',
    '     _Restablecer claves de acceso_',
    '',
    '*2.* 🌐 Problemas con Intranet',
    '     _Acceso y funcionamiento de Intranet_',
    '',
    '*3.* 📶 Problemas con WiFi',
    '     _Conexion inalambrica_',
    '',
    '*4.* 🔒 Problemas con VPN',
    '     _Conexion remota a la red_',
    '',
    '*5.* 🖨️ Problemas de Impresora',
    '     _Configuracion e impresion_',
    '',
    '*6.* ⚡ Problemas con Speedy',
    '     _Sistema Speedy_',
    '',
    '*7.* 🗄️ Problemas con DBNet',
    '     _Sistema DBNet_',
    '━━━━━━━━━━━━━━━━━━━━',
    '',
    '_Escribe el *numero* de la opcion que necesitas._',
  ].join('\n'),

  backToMenu: '↩️ Volviendo al menu principal...',

  unknown: [
    '🤔 No entendi tu mensaje.',
    '',
    'Escribe *hola* para ver el menu de soporte.',
  ].join('\n'),
};
...
const CLAVES = {
  1: {
    ...
    answer: [
      ...
      '━━━━━━━━━━━━━━━━━━━━',
      '',
      'Para restablecer tu clave de correo, comunicate con:',
      '',
      '👤 *Kevin Arriagada*',
      '📱 wa.me/56930919502',
      '',
      '━━━━━━━━━━━━━━━━━━━━',
      '_Escribe *0* para volver al menu._',
    ].join('\n'),
  },
  2: {
    name: 'Clave WSL Token Password',
    answer: [
      '🔐 *Clave WSL Token Password*',
      '━━━━━━━━━━━━━━━━━━━━',
      '',
      'Para restablecer tu token/password de WSL, comunicate con:',
      '',
      '👤 *Kevin Arriagada*',
      '📱 wa.me/56930919502',
      '',
  ...
  3: {
    ...
    answer: [
      ...
      '━━━━━━━━━━━━━━━━━━━━',
      '',
      'Para restablecer tu clave de Intranet, comunicate con:',
      '',
      '👤 *Rony Castillo*',
      '📱 wa.me/56976590469',
      '',
  ...
  4: {
    ...
    answer: [
      ...
      '━━━━━━━━━━━━━━━━━━━━',
      '',
      'Para restablecer tu clave de DBNet, comunicate con:',
      '',
      '👤 *Julio Castillo*',
      '📱 wa.me/56957190055',
      '',
...
const PROBLEMAS = {
  2: {
    ...
    answer: [
      ...
      '━━━━━━━━━━━━━━━━━━━━',
      '',
      'Para resolver tu problema, comunicate con:',
      '',
      '👤 *Rony Castillo*',
      '📱 wa.me/56976590469',
      '',
...
function handleMainMenu(input, from) {
  ...
  if (option === 1) {
    ...
    return [
      ...
      '━━━━━━━━━━━━━━━━━━━━',
      '',
      '_Escribe el *numero* de la opcion, o *0* para volver._',
    ].join('\n');
  }
